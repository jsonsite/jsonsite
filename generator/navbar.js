module.exports = function(page, title, desc, theme){
  var i = 0;
  var html = `<div class="siimple-navbar siimple-navbar--extra-large siimple-navbar--${theme.navbar_color}">
  ...
  html = html + `<div class="siimple-jumbotron siimple-jumbotron--fluid siimple-jumbotron--${theme.jumbotron_color}">
